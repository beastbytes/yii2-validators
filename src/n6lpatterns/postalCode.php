 ...
 * @todo GBR regex is not as good as it could be - look for better
 */

namespace BeastBytes\User\Address\validators;
...
return [
    ...
    'FR' => '/^\d{5}$/', // France
    'GA' => '', // Gabon
    'GB' => '/^[A-Z]{1,2}[0-9][A-Z0-9]? [0-9][ABD-HJLNP-UW-Z]{2}$/', // United Kingdom
    'GD' => '', // Grenada
    'GE' => '', // Georgia
    'GF' => '', // French Guiana
    'GG' => '', // Guernsey
    ...
    'US' => '/^\d{5}(?:[-\s]\d{4})?$/', // United States of America
    'UY' => '', // Uruguay
    'UZ' => '', // Uzbekistan
